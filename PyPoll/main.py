...
print("------------------")
print(f"Khan: {round(percentage(khan_votes, total_votes))}% ({khan_votes})")
print(f"Correy: {round(percentage(correy_votes, total_votes))}% ({correy_votes})")
print(f"Li: {round(percentage(li_votes, total_votes))}% ({li_votes})")
print(f"O\'Tooley: {round(percentage(otooley_votes, total_votes))}% ({otooley_votes})")
print("------------------")
...
f.write("-------------------------\n")
f.write(f"Khan: {round(percentage(khan_votes, total_votes))}% ({khan_votes})\n")
f.write(f"Correy: {round(percentage(correy_votes, total_votes))}% ({correy_votes})\n")
f.write(f"Li: {round(percentage(li_votes, total_votes))}% ({li_votes})\n")
f.write(f"O\'Tooley: {round(percentage(otooley_votes, total_votes))}% ({otooley_votes})\n")
f.write("-------------------------\n")
